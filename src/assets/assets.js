...
export const dummyItemData = [{
    // Changed 'id' to '_id' to match component usage
    id: 1, 
    name: "Casual Shoes",
    category: "Sports",
    price: 100,
...
export const testimonials = [
        ...
        image: "https://images.unsplash.com/photo-1507003211169-0a816d50f678?q=80&w=200", 
        rating: 5, 
        review: "Absolutely outstanding work! Their expertise is clear, and they delivered exactly what was promised ahead of schedule. Will definitely use again." 
    },
    { 
        id: 5, 
        name: "Olivia Müller", 
        ...
        rating: 4, 
        review: "Very reliable and communicative. While there was a slight delay, the final product was of high quality and the team was easy to work with." 
    },
    { 
        id: 6, 
        name: "Ethan Davis", 
        address: "Toronto, Canada", 
        image: "https://images.unsplash.com/photo-1506794778202-dfa112da11d4?q=80&w=200", 
        rating: 5, 
        review: "The level of customer support was superb. Every question was answered quickly and thoroughly. The best service I’ve received in years." 
    },
    { 
        id: 7, 
        name: "Ava García", 
        ...
        rating: 5, 
        review: "Highly recommend! The service was seamless, incredibly fast, and the staff were exceptionally friendly. Five stars across the board." 
    },
    { 
        id: 8, 
        name: "Marcus Koyama", 
        address: "Tokyo, Japan", 
        image: "https://images.unsplash.com/photo-1568602471035-aac213f0e0f2?q=80&w=200", 
        rating: 4.5, 
        review: "Great value for the money. The product itself is fantastic, and the support documentation was very helpful in getting set up quickly." 
    }
    ];
...
// --- MOCK DATA FOR ORDER DETAILS (Used when viewing details) ---
...
export const groupBookingsByVendor = (bookings) => {
    ...
    return bookings.reduce((acc, booking) => {
        ...
        acc[vendorName].push(booking);
        return acc;
    }, {});
};
// -------------------------

// Helper function to find order details (simulating API call)
export const findOrderDetails = (orderId) => {
    // In a real app, this would fetch data based on the ID. 
    // Here, we just return the mock details for the main order ID.
    return orderId === mockOrderDetail.orderId ? mockOrderDetail : null;
};