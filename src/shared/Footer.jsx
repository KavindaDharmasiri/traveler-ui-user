...
                        {/* Instagram */}
                        <svg className="w-6 h-6 hover:text-gray-800 transition-colors cursor-pointer" fill="currentColor" viewBox="0 0 24 24">
...
                        <input type="text" className='bg-white rounded-l border border-gray-300 h-9 px-3 outline-none focus:ring-2 focus:ring-[#217964] focus:border-[#217964]' placeholder='Your email' />
                        <button className='flex items-center justify-center bg-[#217964] hover:bg-[#1a5f4c] transition-colors h-9 w-9 aspect-square rounded-r'>
                            {/* Arrow icon */}
