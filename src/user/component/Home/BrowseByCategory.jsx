  ...
  return (
    <section>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 grid-rows-2 gap-4 h-[500px] md:h-[600px]">
        ...
        <CategoryCard onClick={()=>handleCardClick('VEHICLES')} title="Vehicles" image={imgs.vehicles} className="col-span-1 row-span-1" gradient="from-black/60 to-transparent" />
