  ...
  return (
    <div className="bg-white p-2 rounded-2xl shadow-xl shadow-black/10 w-full max-w-2xl flex flex-col md:flex-row items-stretch gap-2">
      <div className="flex-1 flex items-center px-4 h-14 bg-[#f6f8f7] rounded-xl border border-transparent focus-within:border-[rgba(33,120,100,0.30)] focus-within:bg-white transition-all">
        <Icon name="location_on" className="text-gray-400 mr-3" />
        <div className="flex flex-col items-start w-full">
          <label className="text-[10px] uppercase font-bold text-gray-500 tracking-wide" htmlFor="destination">
            Where
          </label>
          <input
      ...
      <button className="bg-[#217864] hover:bg-[#1a6050] text-white rounded-xl px-8 h-14 md:h-auto font-bold text-base transition-colors shadow-lg shadow-[rgba(33,120,100,0.20)] flex items-center justify-center gap-2">
        <Icon name="search" />
        <span>Search</span>
      </button>
    </div>
