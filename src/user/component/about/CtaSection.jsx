...
export default function CtaSection() {
  ...
  return (
    <section className="py-20 px-8">
      <div className="max-w-[1280px] mx-auto rounded-3xl overflow-hidden bg-[#217864] relative">
        ...
        <div className="relative z-10 flex flex-col items-center text-center py-24 px-6">
          ...
          <p className="text-[#217864]-100 text-xl max-w-2xl mb-10">
          ...
          <div className="flex flex-row gap-4 w-auto">
            <Link to="/rentItems">
              <button className="bg-white text-[#217864] hover:bg-gray-100 font-bold py-3 px-8 rounded-xl transition shadow-lg w-auto">
                Browse Rentals
              </button>
            </Link>
            <button onClick={() => navigate('/signup?role=SERVICE_PROVIDER')}className="bg-transparent border-2 border-white text-white hover:bg-white/10 font-bold py-3 px-8 rounded-xl transition w-auto">
              Become a Host
            </button>
          </div>
        </div>
