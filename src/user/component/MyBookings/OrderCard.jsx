// This component should be saved as ViewOrderDetails.jsx
    ...
    return (
        ...
        >
            ...
            <div className="md:col-span-1 flex justify-start md:justify-end">
                <button 
                    // Prevent card click handler from firing when clicking button, 
                    // though it's already handled by the card click above.
                    onClick={(e) => {e.stopPropagation(); onViewDetails(order.orderId);}} 
