...
export default function SectionTabs({ activeTab, setActiveTab }) {
  ...
  const active = "border-b-[#217964] text-[#181811] ";
  const inactive =
    "border-b-transparent text-[#8c8b5f] hover:text-[#181811] ";

  return (
    <div className="pb-6 sticky top-[73px] z-40 bg-[#f8f8f5]  pt-2">
      <div className="flex border-b border-[#e6e6db]  px-4 gap-8">
        <button
          type="button"
